...
public:
  ...
  using neighbors_per_interval_type = std::map<input_key_type, neighbor_shapes_type>;
  using neighbors_type = std::vector<std::pair<position_interval_type, neighbors_per_interval_type> >;
