...
public:
   ...
   */
  Vertex *insert_point (const db::DPoint &point, std::list<tl::weak_ptr<Polygon> > *new_triangles = nullptr);
...
protected:
   ...
   *  the remove step.
   */
  Vertex *insert_point (db::DCoord x, db::DCoord y, std::list<tl::weak_ptr<Polygon> > *new_triangles = nullptr);
   ...
   *  the remove step.
   */
  void remove (Vertex *vertex, std::list<tl::weak_ptr<Polygon> > *new_triangles = nullptr);
...
private:
  ...
  Edge *find_closest_edge (const db::DPoint &p, Vertex *vstart = nullptr, bool inside_only = false) const;
  Vertex *insert (Vertex *vertex, std::list<tl::weak_ptr<Polygon> > *new_triangles = nullptr);
