...
public:
  ...
  using disp_type = db::disp_trans<C>;
  using polygon_type = db::polygon<C>;
  using polygon_edge_iterator_type = typename polygon_type::polygon_edge_iterator;
  using simple_polygon_type = db::simple_polygon<C>;
  using simple_polygon_edge_iterator_type = typename simple_polygon_type::polygon_edge_iterator;
  using polygon_ref_type = db::polygon_ref<polygon_type, disp_type>;
  using polygon_ref_edge_iterator_type = typename polygon_ref_type::polygon_edge_iterator;
  using simple_polygon_ref_type = db::polygon_ref<simple_polygon_type, disp_type>;
  using simple_polygon_ref_edge_iterator_type = typename simple_polygon_ref_type::polygon_edge_iterator;
...
public:
  ...
  using polygon_type = db::polygon<C>;
  using disp_type = db::disp_trans<C>;
  using polygon_point_iterator_type = typename polygon_type::polygon_contour_iterator;
  using polygon_ref_type = db::polygon_ref<polygon_type, disp_type>;
  using polygon_ref_point_iterator_type = typename polygon_ref_type::polygon_contour_iterator;
  using path_type = db::path<C>;
  using path_point_iterator_type = typename path_type::iterator;
  using path_ref_type = db::path_ref<path_type, disp_type>;
  using path_ref_point_iterator_type = typename path_ref_type::iterator;
...
public:
  ...
  using area_type = coord_traits<coord_type>::area_type; 
  using distance_type = coord_traits<coord_type>::distance_type; 
  using perimeter_type = coord_traits<coord_type>::perimeter_type; 
  ...
  using short_box_type = db::box<coord_type, coord_traits<coord_type>::short_coord_type>;
  ...
  using point_iterator = db::generic_point_iterator<coord_type>;

  using polygon_iter_type = tl::reuse_vector<db::polygon<coord_type> >::const_iterator;
  using simple_polygon_iter_type = tl::reuse_vector<db::simple_polygon<coord_type> >::const_iterator;
  using polygon_ref_iter_type = tl::reuse_vector<db::polygon_ref<polygon_type, disp_type> >::const_iterator;
  using polygon_ptr_iter_type = tl::reuse_vector<db::polygon_ref<polygon_type, unit_trans_type> >::const_iterator;
  using polygon_ptr_array_iter_type = tl::reuse_vector<db::array<polygon_ptr_type, disp_type> >::const_iterator;
  using simple_polygon_ref_iter_type = tl::reuse_vector<db::polygon_ref<simple_polygon_type, disp_type> >::const_iterator;
  using simple_polygon_ptr_iter_type = tl::reuse_vector<db::polygon_ref<simple_polygon_type, unit_trans_type> >::const_iterator;
  using simple_polygon_ptr_array_iter_type = tl::reuse_vector<db::array<simple_polygon_ptr_type, disp_type> >::const_iterator;
  using path_iter_type = tl::reuse_vector<db::path<coord_type> >::const_iterator;
  using path_ref_iter_type = tl::reuse_vector<db::path_ref<path_type, disp_type> >::const_iterator;
  using path_ptr_iter_type = tl::reuse_vector<db::path_ref<path_type, unit_trans_type> >::const_iterator;
  using path_ptr_array_iter_type = tl::reuse_vector<db::array<path_ptr_type, disp_type> >::const_iterator;
  using edge_iter_type = tl::reuse_vector<db::edge<coord_type> >::const_iterator;
  using edge_pair_iter_type = tl::reuse_vector<db::edge_pair<coord_type> >::const_iterator;
  using point_iter_type = tl::reuse_vector<db::point<coord_type> >::const_iterator;
  using text_iter_type = tl::reuse_vector<db::text<coord_type> >::const_iterator;
  using text_ref_iter_type = tl::reuse_vector<db::text_ref<text_type, disp_type> >::const_iterator;
  using text_ptr_iter_type = tl::reuse_vector<db::text_ref<text_type, unit_trans_type> >::const_iterator;
  using text_ptr_array_iter_type = tl::reuse_vector<db::array<text_ptr_type, disp_type> >::const_iterator;
  using user_object_iter_type = tl::reuse_vector<db::user_object<coord_type> >::const_iterator;
  using box_iter_type = tl::reuse_vector<db::box<coord_type> >::const_iterator;
  using box_array_iter_type = tl::reuse_vector<db::array<box_type, unit_trans_type> >::const_iterator;
  using short_box_iter_type = tl::reuse_vector<db::box<coord_type, coord_traits<coord_type>::short_coord_type> >::const_iterator;
  using short_box_array_iter_type = tl::reuse_vector<db::array<short_box_type, unit_trans_type> >::const_iterator;

  using ppolygon_iter_type = tl::reuse_vector<db::object_with_properties<db::polygon<coord_type> > >::const_iterator;
  using psimple_polygon_iter_type = tl::reuse_vector<db::object_with_properties<db::simple_polygon<coord_type> > >::const_iterator;
  using ppolygon_ref_iter_type = tl::reuse_vector<db::object_with_properties<db::polygon_ref<polygon_type, disp_type> > >::const_iterator;
  using ppolygon_ptr_iter_type = tl::reuse_vector<db::object_with_properties<db::polygon_ref<polygon_type, unit_trans_type> > >::const_iterator;
  using ppolygon_ptr_array_iter_type = tl::reuse_vector<db::object_with_properties<db::array<polygon_ptr_type, disp_type> > >::const_iterator;
  using psimple_polygon_ref_iter_type = tl::reuse_vector<db::object_with_properties<db::polygon_ref<simple_polygon_type, disp_type> > >::const_iterator;
  using psimple_polygon_ptr_iter_type = tl::reuse_vector<db::object_with_properties<db::polygon_ref<simple_polygon_type, unit_trans_type> > >::const_iterator;
  using psimple_polygon_ptr_array_iter_type = tl::reuse_vector<db::object_with_properties<db::array<simple_polygon_ptr_type, disp_type> > >::const_iterator;
  using ppath_iter_type = tl::reuse_vector<db::object_with_properties<db::path<coord_type> > >::const_iterator;
  using ppath_ref_iter_type = tl::reuse_vector<db::object_with_properties<db::path_ref<path_type, disp_type> > >::const_iterator;
  using ppath_ptr_iter_type = tl::reuse_vector<db::object_with_properties<db::path_ref<path_type, unit_trans_type> > >::const_iterator;
  using ppath_ptr_array_iter_type = tl::reuse_vector<db::object_with_properties<db::array<path_ptr_type, disp_type> > >::const_iterator;
  using pedge_iter_type = tl::reuse_vector<db::object_with_properties<db::edge<coord_type> > >::const_iterator;
  using pedge_pair_iter_type = tl::reuse_vector<db::object_with_properties<db::edge_pair<coord_type> > >::const_iterator;
  using ppoint_iter_type = tl::reuse_vector<db::object_with_properties<db::point<coord_type> > >::const_iterator;
  using ptext_iter_type = tl::reuse_vector<db::object_with_properties<db::text<coord_type> > >::const_iterator;
  using ptext_ref_iter_type = tl::reuse_vector<db::object_with_properties<db::text_ref<text_type, disp_type> > >::const_iterator;
  using ptext_ptr_iter_type = tl::reuse_vector<db::object_with_properties<db::text_ref<text_type, unit_trans_type> > >::const_iterator;
  using ptext_ptr_array_iter_type = tl::reuse_vector<db::object_with_properties<db::array<text_ptr_type, disp_type> > >::const_iterator;
  using puser_object_iter_type = tl::reuse_vector<db::object_with_properties<db::user_object<coord_type> > >::const_iterator;
  using pbox_iter_type = tl::reuse_vector<db::object_with_properties<db::box<coord_type> > >::const_iterator;
  using pbox_array_iter_type = tl::reuse_vector<db::object_with_properties<db::array<box_type, unit_trans_type> > >::const_iterator;
  using pshort_box_iter_type = tl::reuse_vector<db::object_with_properties<db::box<coord_type, coord_traits<coord_type>::short_coord_type> > >::const_iterator;
  using pshort_box_array_iter_type = tl::reuse_vector<db::object_with_properties<db::array<short_box_type, unit_trans_type> > >::const_iterator;
