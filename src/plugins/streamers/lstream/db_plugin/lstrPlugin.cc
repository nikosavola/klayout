...
{
  std::string format_name () const override { return "LStream"; }
  std::string format_desc () const override { return "LStream"; }
  std::string format_title () const override { return "LStream"; }
  std::string file_format () const override { return "LStream files (*.lstr *.lstr.gz)"; }
