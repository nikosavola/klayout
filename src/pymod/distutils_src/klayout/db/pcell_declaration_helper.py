...
class _PCellDeclarationHelperLayerDescriptor:
  """
...
class _PCellDeclarationHelperParameterDescriptor:
  """
  A descriptor object which translates the PCell parameters into class attributes
...
__all__ = [
  "_PCellDeclarationHelperLayerDescriptor",
